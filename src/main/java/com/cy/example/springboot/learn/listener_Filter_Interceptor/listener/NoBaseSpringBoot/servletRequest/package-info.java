 ...
 *
 *      非 SpringBoot 环境下使用:
 *          1. 实现自己的 ServletRequestListener 监听器, 实现 ServletRequestListener接口.
 *          2. 在 web.xml 中添加监听器的配置
 *              <listener>
 ...
 *          1. 实现自己的 ServletRequestListener 监听器, 实现 ServletRequestListener 或者 ServletRequestAttributeListener 接口.
 *          2. 在自己的监听器上添加注解 : @WebListener
